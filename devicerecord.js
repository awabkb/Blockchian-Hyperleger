...
class DeviceRecord extends State {
    ...
    // Modified createInstance to include lastUpdate
    static createInstance(device_serial, price, manufacturing_date, company, device_type, lastUpdate) {
        return new DeviceRecord({ device_serial, price, manufacturing_date, company, device_type, lastUpdate });
    }
